...
todo_blp = Blueprint("todos", __name__, description="Operations on todos",url_prefix="/todo")
...
def get_todos():
    ...
    #  스키만 사용시 jsonfy 사용 안하고 바로 사용 가능
...
def delete_todo(todo_id):
    ...
    db.session.commit()
    return jsonify({"msg": "Todo deleted successfully","id": todo.id}), 200